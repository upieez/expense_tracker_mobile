    ...
    >
      ...
      <View style={styles.details}>
        <View style={styles.categoryRow}>
          ...
          {expense.photoUri ? (
            <Ionicons name="camera" size={12} color={colors.textSecondary} style={styles.photoDot} />
          ) : null}
        </View>
        {expense.note ? (
...
const styles = StyleSheet.create({
  ...
  category: { fontSize: typography.body, fontWeight: typography.medium, color: colors.textPrimary },
  photoDot: { marginLeft: spacing.xs },
  note: { fontSize: typography.caption, color: colors.textSecondary, marginTop: 2 },
  amount: { fontSize: typography.body, fontWeight: typography.semibold, color: colors.textPrimary },
});
